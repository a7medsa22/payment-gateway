...
export class Payment {
    ...
    markAsSucceeded(providerPaymentId: string, paymentMethodType?: string): void {
        this.ensureStatus(PaymentStatus.PENDING, PaymentStatus.PROCESSING, PaymentStatus.REQUIRES_ACTION);
    ...
    markAsFailed(errorCode: string, errorMessage: string): void {
       if (this._status !== PaymentStatus.PENDING && this._status !== PaymentStatus.PROCESSING && this._status !== PaymentStatus.REQUIRES_ACTION) {
            throw new DomainException(
